...
public:
    MKLDNNDeconvolutionNode(Type type, const std::string &name);
    explicit MKLDNNDeconvolutionNode(InferenceEngine::CNNLayerPtr layer);
    virtual ~MKLDNNDeconvolutionNode() {}
