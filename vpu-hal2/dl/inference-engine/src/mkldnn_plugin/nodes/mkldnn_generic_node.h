...
public:
    MKLDNNGenericNode(Type type, const std::string &name);
    explicit MKLDNNGenericNode(InferenceEngine::CNNLayerPtr layer);
    virtual ~MKLDNNGenericNode();
    ...
    void resolveNotAllocatedEdges() override;

    bool isConstant(bool fromCache) override;
...
protected:
    ...
    std::vector<std::vector<InferenceEngine::LayerConfig>> implsConfigs;
