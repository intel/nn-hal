...
public:
    MKLDNNFullyConnectedNode(Type type, const std::string &name);
    explicit MKLDNNFullyConnectedNode(InferenceEngine::CNNLayerPtr layer);
    virtual ~MKLDNNFullyConnectedNode() {}
