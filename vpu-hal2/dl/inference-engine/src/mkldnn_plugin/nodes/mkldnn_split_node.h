...
public:
    MKLDNNSplitNode(Type type, const std::string &name);
    explicit MKLDNNSplitNode(InferenceEngine::CNNLayerPtr layer);
    virtual ~MKLDNNSplitNode() {}
...
private:
    ...
    bool supported_nChw8c = false;
    bool supported_nChw16c = false;
};
