...
public:
     ...
     * @brief Loads a pre-built network with weights to the engine so it is ready for inference
     ...
     */
    virtual StatusCode
    ImportNetwork(IExecutableNetwork::Ptr &ret, const std::string &modelFileName, ResponseDesc *resp) noexcept = 0;
