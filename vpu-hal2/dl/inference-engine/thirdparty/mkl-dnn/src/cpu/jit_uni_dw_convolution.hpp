    ...
    struct pd_t: public _cpu_convolution_fwd_pd_t<with_relu> {
        pd_t(engine_t *engine,
             ...
             const typename pd_t::base_class *hint_fwd_pd)
                : _cpu_convolution_fwd_pd_t<with_relu>(engine, adesc, attr, hint_fwd_pd)
                , jcp_({}) {}
        ...
        virtual status_t init() override {
            ...
            return jit_uni_dw_conv_fwd_kernel_f32<isa>::init_conf(jcp_, this->cdesc_(),
...
using jit_avx512_common_dw_convolution_fwd_t = _jit_uni_dw_convolution_fwd_t<avx512_common, false>;
using jit_avx2_dw_convolution_fwd_t          = _jit_uni_dw_convolution_fwd_t<avx2, false>;
using jit_sse42_dw_convolution_fwd_t         = _jit_uni_dw_convolution_fwd_t<sse42, false>;

using jit_avx512_common_dw_convolution_relu_t = _jit_uni_dw_convolution_fwd_t<avx512_common, true>;
using jit_avx2_dw_convolution_relu_t          = _jit_uni_dw_convolution_fwd_t<avx2, true>;
using jit_sse42_dw_convolution_relu_t         = _jit_uni_dw_convolution_fwd_t<sse42, true>;
...
struct _jit_uni_dw_convolution_bwd_data_t: public cpu_primitive_t {
    ...
    _jit_uni_dw_convolution_bwd_data_t(const pd_t *pd, const input_vector &inputs,
            const output_vector &outputs)
        : cpu_primitive_t(&conf_, inputs, outputs), conf_(*pd)
...
using jit_avx512_common_dw_convolution_bwd_data_t = _jit_uni_dw_convolution_bwd_data_t<avx512_common>;
using jit_avx2_dw_convolution_bwd_data_t          = _jit_uni_dw_convolution_bwd_data_t<avx2>;
using jit_sse42_dw_convolution_bwd_data_t         = _jit_uni_dw_convolution_bwd_data_t<sse42>;
