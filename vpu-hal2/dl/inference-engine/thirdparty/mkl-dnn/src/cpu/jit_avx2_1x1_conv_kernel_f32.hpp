...
private:
    ...
    Xbyak::Ymm ymm_mask = Xbyak::Ymm(12);
    Xbyak::Ymm ymm_src = Xbyak::Ymm(14);
    Xbyak::Ymm ymm_aux0 = Xbyak::Ymm(12);
    Xbyak::Ymm ymm_aux1 = Xbyak::Ymm(15);

    Xbyak::Reg64 reg_table = aux_reg_load_data;

    inline void simd_expf(const Xbyak::Ymm &ymm_src);
