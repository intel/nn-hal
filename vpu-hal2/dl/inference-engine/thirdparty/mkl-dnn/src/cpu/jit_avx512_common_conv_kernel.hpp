...
private:
    ...
    Xbyak::Zmm zmm_mask = Xbyak::Zmm(28);
    Xbyak::Zmm zmm_src = Xbyak::Zmm(29);
    Xbyak::Zmm zmm_aux0 = Xbyak::Zmm(30);
    Xbyak::Zmm zmm_aux1 = Xbyak::Zmm(31);
    Xbyak::Zmm zmm_aux2 = Xbyak::Zmm(28);

    Xbyak::Reg64 reg_table = aux_reg_inp_prf;

    inline void simd_expf(const Xbyak::Zmm &zmm_src);
