...
private:
    ...
    void avg_step(int ur_w, int pad_l, int pad_r, const char *kh_label, int pad_r_logic);
    ...
    void step(int ur_w, int pad_l, int pad_r, const char *kh_label, int pad_r_logic) {
        if (jpp.alg == alg_kind::pooling_max) {
            ...
            avg_step(ur_w, pad_l, pad_r, kh_label, pad_r_logic);
    }

    void step_high_half(int ur_w, int pad_l, int pad_r, const char *kh_label, int pad_r_logic) {
        ...
        step(ur_w, pad_l, pad_r, kh_label, pad_r_logic);
    }
