...
LOCAL_SRC_FILES := \
	...
	inference-engine/src/vpu/graph_transformer/hw/pack_concat.cpp \
	...
	inference-engine/src/vpu/graph_transformer/optimizations/pack_memory.cpp \
...
LOCAL_CFLAGS += -DENABLE_VPU -DENABLE_MYRIAD -DAKS -DNDEBUG -DIMPLEMENT_INFERENCE_ENGINE_API -D_FORTIFY_SOURCE=2 -fPIE
#LOCAL_CFLAGS += -DAKS
