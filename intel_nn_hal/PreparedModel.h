...
protected:
    ...
    virtual Blob::Ptr GetConstOperandAsTensor(uint8_t operand_index,uint8_t operation_idx);
...
public:
    ...
    virtual Blob::Ptr GetConstOperandAsTensor(uint8_t operand_index,uint8_t operation_idx) override;
