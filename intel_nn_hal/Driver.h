...
//using V11_Model = ::android::hardware::neuralnetworks::V1_1::Model;
...
public:
    ...
    Return<void> getSupportedOperations(const V10_Model& model, getSupportedOperations_cb cb) override;
	...
	Return<ErrorStatus> prepareModel_1_1(const Model& model, ExecutionPreference preference,const sp<IPreparedModelCallback>& callback) override;									
protected:
    std::string mName;
};
